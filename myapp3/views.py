...
def post_detail(request, year, month, slug):
    post = {
        ...
        "content": "В процессе написания очередной программы задумался над тем, какой способ создания списков "
                   "в Python работает быстрее..."
    }
...
class TemplIf(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['message'] = "Привет, Александр!"
        context['number'] = 5
        return context


def view_for(request):
    my_list = ['Машина', 'Самолет', 'Корабль', 'Ракета', 'Метро']
    my_dict = {
    'яблоко': 'красное',
    'Апельсин': 'оранжевые',
    'Осенние листья': 'жёлтые',
    'Летняя трава': 'зелёная',
    'Небо': 'голубое',
    'Море': 'синий',
    'Один из цветов радуги': 'фиолетовый',
    }
